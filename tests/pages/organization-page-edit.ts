...
class OrganizationPageEdit {
  private readonly page: Page;
  private readonly accountingTab: Locator;
  private readonly contactsTab: Locator;
  private readonly aboutorgTab: Locator;
  ...
  constructor(page: Page) {
    ...
    this.contactsTab = this.page.locator("#mat-tab-label-3-2");
